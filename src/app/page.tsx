        ...
        <div className="mx-auto flex h-full w-full max-w-7xl items-center px-6 md:px-10">
          <div className="max-w-3xl text-left text-white">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <a href="https://www.joinblvd.com/b/smilespawellness/widget#/visit-type" className="rounded-full bg-white/10 px-5 py-2.5 text-sm font-semibold text-white ring-1 ring-white/30 backdrop-blur-[1px] hover:bg-white/15">Memberships</a>
              <a href="https://www.joinblvd.com/b/smilespawellness/widget#/visit-type" className="rounded-full bg-white/10 px-5 py-2.5 text-sm font-semibold text-white ring-1 ring-white/30 backdrop-blur-[1px] hover:bg-white/15">Weight Management</a>
              <a href="https://www.joinblvd.com/b/smilespawellness/widget#/visit-type" className="rounded-full bg-white/10 px-5 py-2.5 text-sm font-semibold text-white ring-1 ring-white/30 backdrop-blur-[1px] hover:bg-white/15">Recovery & Performance</a>
              <a href="https://www.joinblvd.com/b/smilespawellness/widget#/visit-type" className="rounded-full bg-white/10 px-5 py-2.5 text-sm font-semibold text-white ring-1 ring-white/30 backdrop-blur-[1px] hover:bg-white/15">Consultations</a>
            </div>
          </div>
        </div>
      </div>
...
// ---------- Headline logic ----------
const lines = [
  "Smile Spa Wellness Peptide Memberships — Strength. Vitality. Longevity. No gimmicks. No guesswork.",
];
...
const ProductsSection: React.FC = () => {
  ...
  const products = categories.slice(0, 6).map(category => {
    ...
    return {
      ...
      category,
      link: 'https://www.joinblvd.com/b/smilespawellness/widget#/visit-type'
    };
  });
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {products.map((product, index) => (
            ...
            >
              ...
              <div aria-hidden className="pointer-events-none absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-black/70 via-black/40 to-transparent" />
          ...
          <figure className="overflow-hidden rounded-3xl bg-white ring-1 ring-neutral-200">
            ...
            <figcaption className="flex items-start gap-2 px-6 pb-6">
              <div>
                ...
                <p className="text-sm text-neutral-600">Medical Director, Smile Spa Wellness</p>
          </div>
            </figcaption>
          </figure>
...
const plans: Plan[] = [
  {
    name: 'Performance Muscle Strengthening & Recovery',
    blurb:
      'Boost performance and enhance recovery with annual nurse consults, monthly recovery meds, body composition tracking, and personalized training plans.',
    price: '$249',
    cadence: 'per month\nbilled monthly',
    features: [
  ...
  {
    name: 'Transformation Weight Loss Package',
    blurb:
      'Metabolic reset with GLP‑1, body scans, 2‑week Lingo CGM, and personalized training & food plans — guided by our nurse practitioners.',
    price: '$399',
    cadence: 'per month\nbilled monthly',
    features: [
      'Annual nurse practitioner consultations',
  ...
  },
  {
    ...
    blurb:
      'Rebuild, repair, and revitalize with bi‑annual nurse visits, monthly peptide medications, training & food plans, and regular body scans.',
    price: '$299',
    cadence: 'per month\nbilled monthly',
    features: [
  ...
  return (
    <section id="pricing" aria-label="Pricing" className="bg-white py-28">
      <div className="mx-auto max-w-[88rem] px-6">
        ...
        <div className="mt-10 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 justify-items-center">
           {plans.map((p) => (
             <div
              key={p.name}
                className={[
                  'relative w-full rounded-3xl p-8 xl:p-10 ring-1 ring-inset ring-neutral-200 shadow-sm flex h-full flex-col',
                p.highlight
  ...
  return (
    <section className="bg-white py-24">
      <div className="mx-auto max-w-5xl px-6">
        ...
        {/* 2. Explaining GH peptides simply */}
        ...
        {/* 3. Describing the process (educational, not medical) */}
        <div className="mt-6 rounded-3xl bg-neutral-50 p-6 ring-1 ring-black/5">
